...
export class ResumeComponent {
  person = { name: 'Gabriel Huertas Marrero', email: 'gabriel.huertas@live.com' };
  skills = [
    ...
    { name: 'ELK Stack', level: 'Proficient' },
